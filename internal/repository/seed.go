...
func seedExec() domain.Exec {
	return domain.Exec{
		...
		Batal:            31,
		TotalPenjualan:   113,
		RevenueAkad:      68810000000,
		PotentialRevenue: 27390000000,
		AdsSpent:         510999293,
...
func seedMonthly() []domain.MonthPoint {
	return []domain.MonthPoint{
		...
		{M: "Jun", Akad: 0, Booking: 8},
	}
}

// seedFunnel is the LEADS-only funnel per BRD BR-9: it ends at PURCHASER (74),
...
// Booking 144 / Akad 103 / Cash-In are NOT funnel stages — they are shown
...
func seedFunnel() []domain.FunnelStage {
	return []domain.FunnelStage{
		{Key: "Leads", Value: 20291, Target: 20291, Owner: "Marketing", Std: nil},
		{Key: "Valid Leads", Value: 13255, Target: 16233, Owner: "Marketing", Std: intp(80)},
		{Key: "Confirmed Visit", Value: 711, Target: 2651, Owner: "Sales", Std: intp(20)},
		{Key: "Project Visitor", Value: 362, Target: 498, Owner: "Sales", Std: intp(70)},
		{Key: "Purchaser", Value: 74, Target: 109, Owner: "Sales", Std: intp(30)},
	}
}

func seedProjects() []domain.Project {
	return []domain.Project{
		{Code: "VERLIM3", Name: "Vertihauz Limo-3", Total: 23, Akad: 19, Proses: 2, Batal: 2, Rev: 14413330000, Ads: 60128211, CPA: 3.16, Eff: "Excellent", Cat: "utama", Stock: domain.Stock{Total: 96, Closed: 70, Booking: 3, Avail: 23}},
		{Code: "ZHL", Name: "Z Hauz Limo", Total: 38, Akad: 22, Proses: 13, Batal: 3, Rev: 12386600000, Ads: 54340049, CPA: 2.47, Eff: "Excellent", Cat: "utama", Stock: domain.Stock{Total: 65, Closed: 22, Booking: 10, Avail: 33}},
		...
		{Code: "VERUA", Name: "Vertihome Serua", Total: 13, Akad: 7, Proses: 3, Batal: 3, Rev: 4877600000, Ads: 53526938, CPA: 7.65, Eff: "Excellent", Cat: "pendukung", Stock: domain.Stock{Total: 26, Closed: 14, Booking: 3, Avail: 9}},
		...
		{Code: "THPJ", Name: "The Hauz Premiere Jagakarsa", Total: 8, Akad: 0, Proses: 2, Batal: 6, Rev: 0, Ads: 31514508, CPA: 0, Eff: "No Akad", Cat: "pembenahan", Stock: domain.Stock{Total: 22, Closed: 0, Booking: 2, Avail: 20}},
	}
}

func seedChannels() []domain.Channel {
	return []domain.Channel{
		{Code: "WA", Name: "WhatsApp", Total: 47, Akad: 24, Conv: 51},
		{Code: "IG", Name: "Instagram (Meta Ads)", Total: 32, Akad: 14, Conv: 44},
...
func seedSales() []domain.SalesRep {
	return []domain.SalesRep{
		{Name: "Ardan", Role: "Internal", Project: "LHL", Akad: 13, Proses: 5, Batal: 5, Total: 23, Conv: 57, Rev: 9291600000},
		{Name: "Ayu", Role: "Internal", Project: "VERLIM3", Akad: 11, Proses: 1, Batal: 1, Total: 13, Conv: 85, Rev: 8080030000},
		{Name: "Iwan", Role: "Internal", Project: "ZHL, VERBUR", Akad: 10, Proses: 8, Batal: 3, Total: 21, Conv: 48, Rev: 5431200000},
		{Name: "Martin", Role: "Internal", Project: "VERUA", Akad: 8, Proses: 3, Batal: 3, Total: 14, Conv: 57, Rev: 5603100000},
		...
		{Name: "Tria", Role: "Internal", Project: "VERLIM3, ZHL", Akad: 5, Proses: 5, Batal: 0, Total: 10, Conv: 50, Rev: 2492400000},
		...
		{Name: "Teguh", Role: "Internal", Project: "ZHL, VERLIM3", Akad: 1, Proses: 0, Batal: 1, Total: 2, Conv: 50, Rev: 654800000},
...
func seedAlerts() []domain.Alert {
	return []domain.Alert{
		...
		{Sev: "kuning", Title: "Data integrity akad belum konsisten", Detail: "Headline 103 vs per-project 95 vs sales breakdown 86 akibat ketidakseragaman kode project (THP J↔THPJ).", PIC: "AI Dept", Deadline: "Minggu ini", Action: "Samakan kode project & tetapkan satu sumber data tunggal."},
		{Sev: "kuning", Title: "Batal 31 unit (21,5% dari booking)", Detail: "43 → 41 booking masih proses, 31 batal. Risiko cash-in tertahan ±Rp27,39 M.", PIC: "KPR / Finance", Deadline: "Minggu ini", Action: "Eskalasi dokumen KPR & pendampingan akad pipeline aktif."},
...
func seedKPIs() []domain.KPI {
	return []domain.KPI{
		{No: 1, Name: "Valid Leads Rate", Value: 65.3, Target: 80, Unit: "%", Owner: "Marketing", Good: false},
		{No: 2, Name: "Leads → CV Rate", Value: 5.4, Target: 20, Unit: "%", Owner: "Sales", Good: false},
		{No: 3, Name: "CV → PV Rate", Value: 50.9, Target: 70, Unit: "%", Owner: "Sales", Good: false},
		{No: 4, Name: "PV → Purchaser Rate", Value: 20.4, Target: 30, Unit: "%", Owner: "Sales", Good: false},
		{No: 5, Name: "Booking → Akad Rate", Value: 71.5, Target: 70, Unit: "%", Owner: "Sales/KPR", Good: true},
		{No: 6, Name: "Cash-In Achievement", Value: 71.5, Target: 100, Unit: "%", Owner: "Finance/KPR", Good: false},
		{No: 7, Name: "Agent Booking Contrib.", Value: 7.6, Target: 15, Unit: "%", Owner: "Agent Coord", Good: false},
		{No: 8, Name: "Cost / Booking (avg)", Value: 3.55, Target: 5, Unit: "Jt", Owner: "Marketing", Good: true, LowerBetter: true},
	}
}
